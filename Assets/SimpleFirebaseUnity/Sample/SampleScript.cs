...
public class SampleScript : MonoBehaviour
{
    ...
    {
        Firebase iot = firebase.Child("Status", true);
        iot.SetValue(1, "Status");
    }

    public void TriggerFireOff()
    {
        Firebase iot = firebase.Child("Status", true);
        iot.SetValue(0, "Status");
    }
    ...
    IEnumerator Tests()
    {
        ...
        firebase = Firebase.CreateNew("https://vriot-ae6e8.firebaseio.com", "AIzaSyCb3TyjcvkcMzJRJed5tC3wqhvnWckScDk");
